...
void api::v1::contfour::getItem(const HttpRequestPtr &req,
...
void api::v1::contfour::putItem(const HttpRequestPtr &req,
               std::function<void (const HttpResponsePtr &)> &&callback,
               std::string key)
{
...
void api::v1::contfour::delItem(const HttpRequestPtr &req,
                std::function<void (const HttpResponsePtr &)> &&callback,
                std::string key)
{
    std::string value;
