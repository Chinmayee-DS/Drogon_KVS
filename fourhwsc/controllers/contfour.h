...
namespace v1
{
class contfour : public drogon::HttpController<contfour>
{
  public:
    ...
    // ADD_METHOD_VIA_REGEX(TestCtrl::getItem, "/{key}", Get);
        ADD_METHOD_TO(contfour::getItem,"/{key}",Get);
        ADD_METHOD_TO(contfour::putItem, "/{key}", Post);
        ADD_METHOD_TO(contfour::delItem, "/{key}", Delete);
