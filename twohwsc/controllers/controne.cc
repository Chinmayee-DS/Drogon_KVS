...
void api::v1::controne::getItem(const HttpRequestPtr &req,
...
void api::v1::controne::putItem(const HttpRequestPtr &req,
               std::function<void (const HttpResponsePtr &)> &&callback,
               std::string key)
{
...
void api::v1::controne::delItem(const HttpRequestPtr &req,
                std::function<void (const HttpResponsePtr &)> &&callback,
                std::string key)
{
    std::string value;
